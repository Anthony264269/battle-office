 ...
 */
final class Version20240320122609 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE shipping ADD country_id INT DEFAULT NULL, DROP country');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE shipping ADD country VARCHAR(255) DEFAULT NULL, DROP country_id');
    }
}
