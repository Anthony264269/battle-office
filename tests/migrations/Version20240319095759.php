 ...
 */
final class Version20240319095759 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04AD462F07AF FOREIGN KEY (product_order_id) REFERENCES `order` (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
